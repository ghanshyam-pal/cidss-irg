...
export default function AppShell() {
  ...
  return (
    <div
      className={`${styles.shell} ${sidebarOpen ? styles.open : styles.collapsed}`}
    >
      {/* ── Sidebar ── */}
                ...
                return (
                  <div key={mod.id} className={styles.navParentBlock}>
                    ...
                    >
                      ...
                      {sidebarOpen && (
                        <span
                          className={`${styles.navChevron} ${isExpanded ? styles.chevronOpen : ""}`}
                        >
                          ▾
                        </span>
                      )}
                        ...
                        {mod.children.map((child) => (
                          ...
                          >
                            ...
                            {ALERT_MODULES[child.id] && (
                              <span className={styles.navBadgeSmall}>
                                {ALERT_MODULES[child.id]}
                              </span>
                            )}
                          </NavLink>
        ...
        <header className={styles.header}>
          <div className={styles.headerLeft}>
            <h1 className={styles.pageTitle}>
              {pageParentLabel && (
                <span className={styles.pageTitleParent}>
                  {pageParentLabel}{" "}
          ...
          <div className={styles.headerActions}>
            ...
            {/* Refresh */}
            <button className={styles.headerIconBtn} title="Refresh data">
              🔄
            </button>
            ...
            {/* User */}
            <div
              className={styles.userMenuHeader}
              onClick={logout}
              title="Sign out"
            >
