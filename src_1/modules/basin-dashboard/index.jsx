...
const AlertBadge = ({ status, small }) => {
  ...
  return (
    ...
    >
      <span
        style={{ width: 5, height: 5, borderRadius: "50%", background: d.dot }}
      />
      {d.label}
    </span>
  );
...
function MapControls() {
  ...
  return (
    ...
    >
      <button style={btnStyle} onClick={() => map.zoomIn()}>
        🔍+
      </button>
      <button style={btnStyle} onClick={() => map.zoomOut()}>
        🔍-
      </button>
      <button style={btnStyle} onClick={() => map.fitBounds(SL_BOUNDS)}>
        ⛶
      </button>
    </div>
  );
    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 24 }}>
          ...
          <div
            style={{ display: "flex", gap: 20, fontSize: 12, color: "#475569" }}
          >
        ...
        <div style={{ display: "flex", gap: 8 }}>
          {["All Basins", "Kalu", "Kelani", "Mahaweli", "Nilwala"].map(
            (b, i) => (
              <button
                key={b}
                style={{
          ...
          {[
            {
              ...
              loc: "Kalu Basin · Western Province",
              color: "#ef4444",
              bg: "#fef2f2",
              border: "#fecaca",
            },
            {
              ...
              clock: "13:45 LKT",
              date: "17 Jun 2026",
              title: "Severe flood situation at Millakanda",
              loc: "Station · Kalu Ganga",
              color: "#f59e0b",
              bg: "#fffbeb",
              border: "#fde68a",
            },
            {
              type: "Water Discharge Alert",
              sev: "Watch",
              time: "1 day ago",
              clock: "10:00 LKT",
              date: "16 Jun 2026",
              title: "Flood alert — rising discharge",
              loc: "Barrage · Walawe River",
              color: "#16a34a",
              bg: "#f0fdf4",
              border: "#bbf7d0",
            },
                        ...
                        >
                          ...
                          <td
                            style={{
                              ...
                              fontWeight: 700,
                              color:
                                g.level > g.threshold ? "#dc2626" : "#0f172a",
        ...
        >
          ...
          >
            ...
            {RESERVOIR_DATA.map((r) => {
              const c =
                r.pct > 90 ? "#dc2626" : r.pct > 75 ? "#f59e0b" : "#3b82f6";
              return (
            ...
            {RECENT_ALERTS.map((a, i) => (
              <div
                ...
                style={{
                  ...
                  paddingBottom: 10,
                  borderBottom:
                    i < RECENT_ALERTS.length - 1 ? "1px solid #f8fafc" : "none",
                }}
              >
                <div
                  style={{
