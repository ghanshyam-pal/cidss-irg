...
const BasinMapWidget = memo(
  ({
    ...
    return (
      <div className="bg-white rounded-2xl shadow-sm shadow-slate-200/40 border border-slate-100/90 overflow-hidden flex flex-col w-full max-w-full">
        ...
        {/* Map Rendering Container */}
        <div className="relative w-full max-w-full bg-slate-100 flex-1">
          <MapContainer
            center={SL_CENTER}
            zoom={6.4}
            minZoom={6}
