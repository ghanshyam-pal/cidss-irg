...
export const GAUGE_DATA = [
  ...
  {
    id: "G03",
    name: "Mahaweli – Manampitiya",
    basin: "Mahaweli",
    subbasin: "Middle Mahaweli",
    type: "river",
    lat: 7.888,
    lng: 81.098,
    level: 2.1,
  ...
  {
    id: "G05",
    name: "Nilwala – Pitabeddara",
    basin: "Nilwala",
    subbasin: "Upper Nilwala",
    type: "river",
    lat: 5.983,
    lng: 80.533,
    level: 3.78,
  ...
  {
    id: "G06",
    name: "Attanagalu – Horombawa",
    basin: "Attanagalu",
    subbasin: "Lower Attanagalu",
    type: "river",
    lat: 7.133,
    lng: 80.016,
    level: 2.45,
  ...
  {
    id: "G07",
    name: "Deduru Oya – Dambulla",
    basin: "Deduru",
    subbasin: "Upper Deduru",
    type: "river",
    lat: 7.866,
    lng: 80.649,
    level: 0.88,
  ...
  {
    id: "G08",
    name: "Walawe – Embilipitiya",
    basin: "Walawe",
    subbasin: "Upper Walawe",
    type: "river",
    lat: 6.333,
    lng: 80.85,
    level: 5.1,
  ...
  {
    id: "R01",
    name: "Kotmale Rain Gauge",
    basin: "Mahaweli",
    subbasin: "Upper Mahaweli",
    type: "rain",
    lat: 6.998,
    lng: 80.633,
    level: null,
...
export const ACTIVE_ALERTS = [
  ...
  },
  {
    ...
    clock: "13:45 LKT",
    date: "17 Jun 2026",
    title: "Severe flood at Millakanda",
    loc: "Kalu Ganga · Station G01",
    color: "#f59e0b",
    bg: "#fffbeb",
    border: "#fde68a",
    stations: ["G01"],
  ...
  {
    id: "AL003",
    type: "Major Flood Alert",
    severity: "Critical",
    time: "2 hours ago",
    clock: "12:45 LKT",
    date: "17 Jun 2026",
    title: "Major flood — Walawe basin",
    loc: "Walawe · Embilipitiya",
    color: "#dc2626",
    bg: "#fef2f2",
    border: "#fecaca",
    stations: ["G08"],
  ...
  {
    id: "AL004",
    type: "Minor Flood Alert",
    severity: "Warning",
    time: "3 hours ago",
    clock: "11:45 LKT",
    date: "17 Jun 2026",
    title: "Rising levels at Pitabeddara",
    loc: "Nilwala · Pitabeddara",
    color: "#f97316",
    bg: "#fff7ed",
    border: "#fed7aa",
    stations: ["G05"],
  ...
  },
  {
    ...
    clock: "10:45 LKT",
    date: "17 Jun 2026",
    title: "Kotmale nearing 95% capacity",
    loc: "Kotmale Reservoir",
    color: "#ca8a04",
    bg: "#fef9c3",
    border: "#fde68a",
    stations: ["RS01"],
  ...
  },
  {
    ...
    clock: "10:00 LKT",
    date: "16 Jun 2026",
    title: "Rising discharge — Walawe Barrage",
...
const makeLevel = (base, noise) =>
  HOURS.map((h, i) => ({
    ...
    observed: +(
      base +
      Math.sin(i * 0.4) * noise +
      (Math.random() - 0.5) * 0.2
    ).toFixed(2),
    forecast: +(
      base +
      Math.sin(i * 0.4) * noise * 1.1 +
      0.15 +
      (Math.random() - 0.5) * 0.1
    ).toFixed(2),
  }));
